...
async def profil5(ctx):
    ...
    embed.add_field(name="Expérience", value="Level 1 ->  0,7/5 🔅", inline=True)
    embed.add_field(name="Amitié", value="0,3 💫", inline=True)
    embed.add_field(name="Capacités", value="0 ⭐ Force\n0 ⭐ Vitesse\n0,5 ⭐ Stratégie\n0 ⭐ Pouvoir\n0 ⭐ Courage", inline=False)
    embed.add_field(name="Techniques spéciales", value="None ❌", inline=True)
    await ctx.send(embed=embed)
...
async def top(ctx):
    ...
    embed.add_field(name="#1: Big Sun", value="90559 pts", inline=False)
    embed.add_field(name="#2: Moonight", value="86818 pts", inline=False)
    embed.add_field(name="#3: Fire Tornado", value="72364 pts", inline=False)
    embed.add_field(name="#4: Dark Light", value="65262 pts", inline=False)
    embed.add_field(name="#5: The Bright", value="62208 pts", inline=False)
    embed.add_field(name="#6: Nod", value="41848 pts", inline=False)
    embed.add_field(name="#7: Teleport Speed", value="40577 pts", inline=False)
    embed.add_field(name="#8: Silver Fist", value="34585 pts", inline=False)
    embed.add_field(name="#9: Counter", value="25819 pts", inline=False)
    embed.add_field(name="#10: Eveillor", value="12333 pts", inline=False)
    await ctx.send(embed=embed)
@bot.command()
async def maj(ctx):
    embed=discord.Embed(title=" ━━━━━━━━━━━━━━━━━━━━━", color=0x636363)
